            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-5 py-5">
                            ...
                            <div class="container">
                                <div class="login-form">
                                    ...
                                    <form @submit.prevent="login" class="pt-4">
                                        ...
                                        <input v-model="form.name" label="Name" class="form-control mb-3" type="text"
                                            required />

                                        <p style="color: #4a5568; font-weight: 700">Username</p>
                                        <input v-model="form.username" label="Username" class="form-control mb-3"
                                            type="text" required />

                                        <p style="color: #4a5568; font-weight: 700">Email</p>
                                        <input v-model="form.email" label="Email" class="form-control mb-3" type="email"
                                            required />

                                        <p style="color: #4a5568; font-weight: 700">Phone</p>
                                        <input v-model="form.phone" label="Phone" class="form-control mb-3"
                                            type="number" required />

                                        <p style="color: #4a5568; font-weight: 700">Password</p>

                                        <input v-model="form.password" :rules="passwordRules" label="Password"
                                            type="password" class="form-control mb-5" required />

                                        <p style="color: #4a5568; font-weight: 700">Confirm Password</p>

                                        <input v-model="form.password_confirmation" :rules="passwordRules"
                                            label="Password" type="password" class="form-control" required />
                        ...
                        <div class="others">
                            <p>
                                <router-link style="color: black; font-weight: 600" to="/auth/login">
    ...
    methods: {
        login() {
            if (Object.keys(this.form).length < 2) {
                ...
                this.loading = true;
                axios
                    .post(this.dynamic_route("/auth/register"), this.form)
                    .then((res) => {
                        this.loading = false;
