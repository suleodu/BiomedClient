            ...
            <div class="row">
              <div class="col-xl-5 col-lg-7 col-md-8">
                <div class="hero__text">
                  ...
                  <p>
                    BioMed’s Veterinary diagnostics section offers a wide range
                    of diagnostics kits such like ELISA, PCR, rapid test kits
                    and any other technics or technologies that can help in the
                    diagnostics processes of the animal diseases and/or related
                    disease.
                  </p>
                  <a href="#" class="primary-btn"
                    >Explore <span class="arrow_right"></span
                  ></a>
            ...
            <div class="row">
              <div class="col-xl-5 col-lg-7 col-md-8">
                <div class="hero__text">
                  ...
                  <p>
                    BioMed’s Human diagnostics section offers a wide range of
                    diagnostics kits and reagents such like ELISA, PCR, rapid
                    test kits and any other technics our technologies that can
                    help in the diagnostic process of the human diseases and/or
                    related diseases.
                  </p>
                  <a href="#" class="primary-btn"
                    >Explore <span class="arrow_right"></span
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="blog__item">
              <div
                ...
                data-setbg="assets/img/blog/blog-1.jpg"
              ></div>
              <div class="blog__item__text">
                <span
                  ><img src="assets/img/icon/calendar.png" alt="" /> 16 February
                  2020</span
                >
          ...
          <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="blog__item">
              <div
                class="blog__item__pic set-bg"
                data-setbg="assets/img/blog/blog-2.jpg"
              ></div>
              <div class="blog__item__text">
                <span
                  ><img src="assets/img/icon/calendar.png" alt="" /> 21 February
                  2020</span
                >
          ...
          <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="blog__item">
              <div
                class="blog__item__pic set-bg"
                data-setbg="assets/img/blog/blog-3.jpg"
              ></div>
              <div class="blog__item__text">
                <span
                  ><img src="assets/img/icon/calendar.png" alt="" /> 28 February
                  2020</span
                >
